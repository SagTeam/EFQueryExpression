namespace Sag.Data.Common.Query
{
    internal static class MsgStrings
    {
        ...
        internal static string TypeCannotNull = _Resources.TypeCannotNull;

      //  internal static string MemberNotDefinedForType = _Resources.MemberNotDefinedForType;

      //  internal static string TypeParameterIsNotDelegate = _Resources.TypeParameterIsNotDelegate;

      //  internal static string InvalidLvalue = _Resources.Invalidvalue;

      //  internal static string TypeContainsGenericParameters = _Resources.TypeContainsGenericParameters;

      //  internal static string InvalidObjectType = _Resources.InvalidObjectType;

      //  internal static string TypeNotIEnumerable = _Resources.TypeNotIEnumerable;

        internal static string InvalidTypeConvert = _Resources.InvalidTypeConvert;
